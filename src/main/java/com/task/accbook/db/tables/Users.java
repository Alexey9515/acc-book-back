...
public class Users extends TableImpl<UsersRecord> {
    ...
    private static final long serialVersionUID = -1478517724;
     ...
     */
    public final TableField<UsersRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(155).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.USERS_NAME_KEY, Indexes.USERS_PK);
    }
    ...
    public List<UniqueKey<UsersRecord>> getKeys() {
        return Arrays.<UniqueKey<UsersRecord>>asList(Keys.USERS_PK, Keys.USERS_NAME_KEY);
    }
